...
(function() {
  ...
  function Tags(tag) {
    ...
    function createTag(name) {
      var tag = create('div', {
        'className': 'node-btn show tag',
        'innerHTML': '<div class="v-content">' + name + 
        			 '</div><div class="c1"></div><div class="c2"></div>' + 
        			 '<div class="tag__remove icon"><img src="../../img/icons/remove.png"></div>'
      });
